...
/** Ic sayfalarin ortak baslik bloğu. */
    ...
    <>
      <div className="hero-wash border-b border-border">
        <div className="mx-auto max-w-[86rem] px-6 py-14 lg:py-20">
          ...
          {lead && <p className="prose-measure mt-5 text-[17px] leading-[1.8] text-fg-muted">{lead}</p>}
        </div>
      </div>

      <div className="mx-auto max-w-[86rem] px-6 py-14 lg:py-20">{children}</div>
    </>
  );
}
